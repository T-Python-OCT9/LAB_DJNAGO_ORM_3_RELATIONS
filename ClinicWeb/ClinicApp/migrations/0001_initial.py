    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('specialization', models.CharField(choices=[('FamilyMedicine', 'Familymedicine'), ('Surgery', 'Surgery'), ('Anesthesiology', 'Anesthesiology'), ('Physiotherapy', 'Physiotherapy'), ('Dental', 'Dental')], default='FAMILYMEDICINE', max_length=256)),
